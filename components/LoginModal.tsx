    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
      ...
      <div className="bg-white rounded-lg shadow-2xl w-full max-w-md relative z-10 overflow-hidden animate-fade-in-up">
        ...
        <div className="bg-lexcora-blue p-6 text-center relative">
          ...
          <h2 className="text-2xl font-serif font-bold text-white tracking-widest">LEXCORA</h2>
        ...
        <div className="p-8 space-y-6">
          <div className="space-y-4">
            <button className="w-full flex items-center justify-between p-4 border border-slate-200 rounded hover:border-lexcora-gold hover:bg-slate-50 transition-all group">
